...
namespace Q_Tech_Bookkeeping
{
    ...
    public void setManageProjects(Manage_Proj frmMP, HomeOld frmHome)
    {
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (HomeOld));
