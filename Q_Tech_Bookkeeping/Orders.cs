...
namespace Q_Tech_Bookkeeping
{
  public class Orders : Form
  {
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (Orders));
      ...
      this.Name = nameof (Orders);
      this.Text = nameof (Orders);
