...
{
  public class Inv_Send_Edit_DelOld : Form
  {
    ...
    {
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (Inv_Send_Edit_DelOld));
      ...
      this.Name = nameof (Inv_Send_Edit_DelOld);
