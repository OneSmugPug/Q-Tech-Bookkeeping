...
{
  public class Proj_Edit_DelOld : Form
  {
    ...
    {
      this.txt_PED_CCode.Text = this.dt.Rows[Proj_Edit_DelOld.SELECTED_PROJECT]["Client_Code"].ToString().Trim();
      this.txt_PED_CName.Text = this.dt.Rows[Proj_Edit_DelOld.SELECTED_PROJECT]["Client_Name"].ToString().Trim();
      this.txt_PED_ProjCode.Text = this.dt.Rows[Proj_Edit_DelOld.SELECTED_PROJECT]["Project_ID"].ToString().Trim();
      this.dtp_PED_Date.Value = !(this.dt.Rows[Proj_Edit_DelOld.SELECTED_PROJECT]["Date"].ToString() != string.Empty) ? DateTime.Now : Convert.ToDateTime(this.dt.Rows[Proj_Edit_DelOld.SELECTED_PROJECT]["Date"].ToString());
      this.txt_PED_Desc.Text = this.dt.Rows[Proj_Edit_DelOld.SELECTED_PROJECT]["Description"].ToString().Trim();
      this.txt_PED_QNum.Text = this.dt.Rows[Proj_Edit_DelOld.SELECTED_PROJECT]["Quote_Number"].ToString().Trim();
    }
    ...
    private void InitializeComponent()
    {
      ...
      this.Name = nameof (Proj_Edit_DelOld);
      this.StartPosition = FormStartPosition.CenterScreen;
      this.Text = nameof (Proj_Edit_DelOld);
